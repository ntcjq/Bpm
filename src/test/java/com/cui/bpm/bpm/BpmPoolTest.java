...
import com.cui.bpm.bpm.model.User;
...
public class BpmPoolTest {
    ...
    public void deployProcess() {
        ...
        builder.addClasspathResource("processes/poolLane.bpmn");//bpmn文件的名称
        builder.deploy();
    ...
    public void createProcessHoliday() {
        ...
        var.put("leader", "cjq");
//        var.put("finance", "zhangsan");
        ProcessInstance finance = runtimeService.startProcessInstanceByKey("poolLane", var);//流程的名称
        System.out.println("InstanceId:" + finance.getProcessInstanceId());
    }
...
//        taskService.setVariable(taskId, "leaderAudit", 1);
//        taskService.setVariable(taskId, "finance", "ssn,cjq");
//        taskService.setVariable(taskId, "ceo", "cjq");
//        taskService.setVariable(taskId, "cfo", "ssn");

//        taskService.claim(taskId, "cjq");
        //审批
//        taskService.complete(taskId);
        //任务委派，加签
//        taskService.delegateTask(taskId,"mm");
