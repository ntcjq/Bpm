...
//        var.put("finance", "zhangsan");
        ProcessInstance finance = runtimeService.startProcessInstanceByKey("finance", var);//流程的名称
...
//        taskService.setVariable(taskId, "financeAudit", 1);
